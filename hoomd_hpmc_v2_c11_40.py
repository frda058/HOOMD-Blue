...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 19 10:50:44 2020
...
df = pandas.read_table('rcp11.txt', delim_whitespace=True, names=("x", "y", "z", "radius", "boxLen"))
...
df1 = df.sort_values('radius')
df1= df1[~(df1['radius'] == rad_particleA)]  
...
all = hoomd.group.all() 
hoomd.dump.gsd('./snapshot2_phi66_case11_phi53_100K_TS_10S.gsd', period=1, group=all, overwrite=True)
...
snapshots = gsd.hoomd.open(name='./snapshot2_phi66_case11_phi53_100K_TS_10S.gsd', mode="rb")

# Create a text file for snapshot data
f = open('snapshot2_phi66_case11_phi53_100K_TS_10S.txt',"w+")
